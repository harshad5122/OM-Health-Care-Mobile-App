...
//                           children: [
//                             // Icon(Icons.logout, color: Get.theme.primaryColor, size: 48),
...
//           }),
//           _buildMenuItem(Icons.event, "Book Appointment", () {
//             // controller?.setSelectedStaff(Global.staffId?? "");
//             // Get.toNamed(AppRoutes.booking_appointment);
//             Get.toNamed(AppRoutes.booking_appointment, arguments: {
//               "doctor": StaffListModel(id: Global.staffId)
//             });
