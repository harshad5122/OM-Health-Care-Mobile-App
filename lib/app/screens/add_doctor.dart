              ...
              children: [
                ...
                Obx(() => controller.professionalStatus.value == "experienced"
                  ...
                  CustomTextField(
                      label: "City*",
                      hint: "Enter city",
                      controller: controller.workCityController, // Use new controller
                      validator: (val) =>
                ...
                sectionCard("Address Information", [
                  ...
                  CustomTextField(
                      label: "City*",
                      hint: "Enter city",
                      controller: controller.cityController, // Use new controller
                      validator: (val) =>
                      val == null || val.isEmpty ? "City is required" : null),
                  const SizedBox(height: 12),
                  CustomTextField(
                ...
                sectionCard("Permanent Address", [
                  ...
                  if (!controller.sameAsCurrent.value) ...[
                    ...
                    CustomTextField(
                        label: "City*",
                        hint: "Enter city",
                        controller: controller.permCityController, // Use new controller
                        validator: (val) =>
                        val == null || val.isEmpty ? "City is required" : null),
                    // Obx(() => CustomDropdown(
                    //   label: "City*",
